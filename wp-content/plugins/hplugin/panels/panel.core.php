...
<script type="text/javascript" data-cfasync="false">
	...
	var plugin_first_release = '<?php if(isset($first_release)){ echo $hplugin_helper->friendly_date($first_release); }else{ echo 'Unknown'; } ?>';
	var plugin_last_updated = '<?php if(isset($last_updated)){ echo $hplugin_helper->friendly_date($last_updated); }else{ echo 'Unknown'; } ?>';
...
<script type="text/javascript" src="<?php echo $plugin_url; ?>/views/sidebar_prepopulation.js" data-cfasync="false"></script>
