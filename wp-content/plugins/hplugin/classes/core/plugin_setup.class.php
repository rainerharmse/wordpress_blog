<?php
	...
	class hplugin_setup{
		...
		public function __construct($plugin_name,$plugin_dir,$plugin_url,$plugin_friendly_name,$plugin_version,$plugin_prefix,$first_release,$last_update,$plugin_friendly_description){	
			...
			$this->display = new hplugin_display($this->plugin_dir);
			//initialise shortcode listener
			$shortcode = new hplugin_shortcodes($this->plugin_prefix,$this->plugin_name,$this->plugin_dir,$this->plugin_url);
		...
		public function add_admin_meta(){
			//load global helper
			global $hplugin_helper;
			if(is_admin() && $hplugin_helper->onAdmin()){ //admin panel
		...
		public function load_admin_javascript(){
			...
			if(is_admin() && $hplugin_helper->onAdmin()){ //admin panel
				//jQuery UI
				wp_register_script('jQueryUI', '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js');
				...
				wp_register_script($this->plugin_prefix .'hplugin_object_manager', $this->plugin_url .'assets/js/hplugin_object_manager.js');
				wp_enqueue_script($this->plugin_prefix .'hplugin_object_manager');
		...
		public function load_admin_css(){
			...
			if(is_admin() && $hplugin_helper->onAdmin()){ //admin panel
				//jQuery UI
				wp_register_style('jQueryUIcss', '//ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css');
